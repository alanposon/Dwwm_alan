...
class OffreEmploi
{
    ...
    {
        return "Identifiant de l'offre d'emploi : " . $this->getIdOffreEmploi() .' Numero offre emploi : ' . $this->getNumeroOffreEmploi() . ' nom de l entreprise : ' . $this->getEntrepriseOffreEmploi() .'date de l offre d emploi  : ' . $this->getDateOffreEmploi() .'description de l offre : ' . $this->getDescriptionOffreEmploi() .'.';
    }
