...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.blossomthemes.com/blossom-spa/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-spa' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-spa' ); ?></a>
    </div><!-- .panel-aside -->
</div>
