...
?> >
            ...
            <input type="number" name="code" id="code" required maxlength="5" <?php if ($act != "ajout")
{
    echo 'value ="' . $p->getCode() . '"';
}
?> >

            <label for="amail">Votre e-mail*</label>
            <input type="email" name="email" id="email" required <?php if ($act != "ajout")
{
