...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Alan_leseigneurdesanneaux_05052020_fc69643c5b3bd9fa2142_20200505095513_archive.zip';
	const ARCHIVE_SIZE		 = '54748027';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fc69643-05095513';
    const SECONDARY_PACKAGE_HASH = 'f4b7d3a-05095513';
