   ...
   if (($setup_zoom != 'undefined') &&
      ...
      $MapName = 'map_ol3js_' . $MapCounter;
		...
		$output = '
				...
				<div id="' . $MapName . '" class="map ' . $setup_map_name . '" data-map_name="' . $setup_map_name . '" data-map="' . $MapName . '" style="width:' . $width_str . '; height:' . $height_str . '; overflow:hidden;border:' . $map_border . '; background-image: url('.OSM_PLUGIN_URL.'/WP_OSM_Plugin_GDPR_01.png); background-repeat: no-repeat; background-position: center; position: relative;" >
