...
<script type="text/javascript">
    ...
    var saveNonce="<?php echo wp_create_nonce('save_nonce'); ?>";
        ...
        <div style="background: #fbfbfb;height: 100px;">
            <div style="text-align: left;height: 55px;" class="bootstrap-wrapper">
                ...
                <div style="padding: 10px;display: flex;justify-content: space-between;align-items: center;">
                    ...
                    <span onclick="location.href='<?php echo admin_url()?>?page=smart_forms_menu'" id="ExitButton" title="Exit" class="fa fa-times" style="font-size: 30px;float: right;"></span>
                </div>
            </div>
