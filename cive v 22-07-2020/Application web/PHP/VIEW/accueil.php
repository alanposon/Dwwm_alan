...
<div class="bas8">
    ...
    <div class="geographie">
        <div class="txtG">
            <p>La Cive travaille sur le territoire NATIONAL, INTERNATIONAL, dans tous types
                d'industries,<br>
                dans le nucléaire et dans son atelier de 800 m². </p>
        </div>
        <div> <img src="IMAGE/carte.png" alt="carte des centrales"></div>
