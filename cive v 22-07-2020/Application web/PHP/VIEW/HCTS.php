...
<div class="titreH1">
    <h1>HCTS <span>NF EN 1090 | RCCM EXC3</span></h1>
</div>
<div class="Bas">
    <div id="slider">
    ...
    <div class="bas1">
        <div class="basGauche">
            <div class="introBG"> <img src="IMAGE/HCTS.png" alt="logo CIVE">
            </div>
...
<img class="edfI" src="IMAGE/edf.png" alt="" />
    ...
    <div class="HCTS5">
        ...
        <div class="disposition">
            <h3>ACTEMIUM | BOCCARD | EDF | ENDEL DGA | ENDEL ENGIE |
                EIFFAGE | FIVES NORDON<BR>EMERSON | NGE FONDATION |
                ORTEC | ORYS | PONTICELLI | RAMERY | SNCF </h3>
        </div>
    ...
    <div class="HCTS6">
        ...
        <div class="disposition">
            <p>Des fournisseurs uniques à moins de 20 minutes pour 90% de nos activités avec lesquelles
                un partenariat s'est créé depuis 2005, ce qui permet de garantir<br>un service réactif et de
                qualité. </p>
        </div>
    </div>
    <div class="HCTS7">
        <div class="fondVert">
            <h2> Une diversité d'activités à votre écoute </h2>
        </div>
        <div class="presentationHH">
            ...
            <h3>Un parc machine pour vous servir</h3>
    ...
    <div class="HCTS8">
        ...
        <div class="geographie">
            ...
            <div> <img src="IMAGE/inter.png" alt="international"></div>
