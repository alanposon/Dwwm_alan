...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 19 juil. 2020 à 16:19
...
INSERT INTO `chantier` (`idChantier`, `matriculeChantier`, `adresseChantier`, `idActivite`, `dateChantier`, `idVille`) VALUES
(2, 202, '181 rue victor hugo', 2, '2020-06-18', 23),
(5, 303, '19 rue franklin', 3, '2020-06-06', 23),
(6, 404, '13 avenue claude françois', 1, '2020-10-22', 23),
(7, 303, '432 rue albert II', 2, '2020-07-22', 2),
(8, 3030, '432 rue albert II', 2, '2020-08-07', 1);
...
(23, 303, 'Chez alan', '2020-08-09', 'on va test '),
(24, 202, 'Carrefour ', '2020-07-12', 'on va test '),
(25, 202, 'Carrefour ', '2020-07-12', 'on va test '),
(26, 202, 'lidl', '2020-08-01', 'test 1.4 ');
...
CREATE TABLE IF NOT EXISTS `planning` (
  ...
  `libellePlanning` int(50) NOT NULL COMMENT 'semaine n° :',
  `dateChantier` date NOT NULL,
...
(1, 20, '2020-06-01', 'soudure', '181 rue victor hugo'),
(3, 16, '2020-08-26', 'tuyauterie', '236 rue michel polnaref ');
...
(35, 'histoire', 'FR', 'Un peu d\'histoire ... '),
(36, 'histoire', 'EN', 'A bit of history'),
(37, 'Effectif', 'FR', 'Effectif'),
(38, 'Effectif', 'EN', 'Effective'),
(39, 'chiffre', 'FR', 'Chiffre d\'affaire'),
(40, 'chiffre', 'EN', 'Sales'),
(41, 'Nos clients', 'FR', 'Nos clients'),
(42, 'Nos clients', 'EN', 'Our guests'),
(43, 'Nos fournisseurs', 'FR', 'Nos fournisseurs'),
(44, 'Nos fournisseurs', 'EN', 'Our suppliers'),
(45, 'equipe', 'FR', 'Des équipes disponibles et compétentes'),
(46, 'equipe', 'EN', 'Available and competent teams'),
(47, 'Savoir', 'FR', 'Un savoir-faire complet'),
(48, 'Savoir', 'EN', 'A complete know-how'),
(49, '800 M² d\'atelier de production', 'FR', '800 M² d\'atelier de production'),
(50, '800 M² d\'atelier de production', 'EN', '800 m² of production facility'),
(51, ' Une mobilité géographique étendue dans différents secteurs', 'FR', ' Une mobilité géographique étendue dans différents secteurs'),
(52, ' Une mobilité géographique étendue dans différents secteurs', 'EN', 'Extended geographical mobility in different sectors'),
(53, 'Les secteurs ', 'FR', 'Les secteurs qui ont recours à nos services sont variés : '),
(54, 'Les secteurs ', 'EN', 'The sectors that use our services are varied: '),
(55, 'Deconnexion', 'FR', 'Déconnexion'),
(56, 'Deconnexion', 'EN', 'Deconnection');
...
(9, 'colomb', 'Christophe', 'Christophe@sfr.fr', '1010', '098f6bcd4621d373cade4e832627b4f6', 2);
