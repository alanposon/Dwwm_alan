...
<div class="bas">
        ...
        <form method="POST" action="">
            ...
            <div class="formPost">
                ...
                <p><label for="numeroOffreEmploi">numero Offre Emploi :</label>
                    <div><?php echo '123456' . $numeroOffreEmploi; ?></div>
                    ...
                    <p><label for="dateOffreEmploi"> Date offre emploi :</label>
                        <input type="date" name="dateOffreEmploi" value="<?php if (isset($_POST['dateOffreEmploi'])) {
                                                                                echo $_POST['dateOffreEmploi'];
                                                                            } ?>" /></p>

                    <p><label for="descriptionOffreEmploi"> Description offre emploi:</label>
                        <textarea name="descriptionOffreEmploi"><?php if (isset($_POST['descriptionoffreEmploi'])) {
    ...
    <div class="formIdent">
        <form method="POST" action="">
            ...
            <!-- bouton parcourir pour les cv lettre de motivation  -->
