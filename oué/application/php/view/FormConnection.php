...
{ // Le formulaire a été validé
...
else // On check le mot de passe
    {
        ...
        if ($utilisateur->getMdp() == md5($_POST['mdp'])) // Acces OK !
        {
            ...
            $message = '<h3>Bienvenue ' . $utilisateur->getPseudo() . ', vous êtes maintenant connecté!</h3>';
            if ($lvl >= 2){
        ...
        {
            $message = '<h3>Une erreur s\'est produite 	    pendant votre identification.<br /> Le mot de passe ou le pseudo
