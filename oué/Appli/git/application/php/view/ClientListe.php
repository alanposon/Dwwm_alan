...
<div class="ligne">
    ...
    <div class="bloc titre">codePostal</div>
    <div class="bloc titre">email</em></div>
    <div class="bloc titre">idVille </div>
...
?>
    <div class="ligne">
        ...
        <div class="bloc contenu"><?php echo $elt->getCodePostal() ?></div>
        <div class="bloc contenu"><?php echo $elt->getEmail() ?></div>
